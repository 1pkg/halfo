...
public:
	...
	const std::array<cocos2d::Vec2, 2> & anvil() const;
	const std::array<cocos2d::Vec2, 4> & edge() const;
	const std::array<cocos2d::Vec2, 2> & platform() const;
...
private:
	...
	std::array<cocos2d::Vec2, 2> _slice;
	std::array<	cocos2d::Vec2, 2> _anvil;
	std::array<cocos2d::Vec2, 4> _edge;
	std::array<cocos2d::Vec2, 2> _platform;
	std::array<cocos2d::Vec2, 2> _over;
};
